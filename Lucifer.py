...
def api1(ids,names,passlist):
		try:
			...
			for pw in passlist:
				...
				ua_string = random.choice(['Mozilla/5.0 (iPhone 4 X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/8.1.1 Mobile/iPhone8,7 Safari/604.1','Mozilla/5.0 (iPhone 4 X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/7.1.1 Mobile/iPhone12,2 Safari/604.1','Mozilla/5.0 (iPhone 5 X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/9.1.1 Mobile/iPhone12,6 Safari/604.1','Mozilla/5.0 (iPhone 5 X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/8.1.1 Mobile/iPhone5,1 Safari/604.1'])
				li = ['28','29','30']
...
def api2(ids,names,passlist):
        try:
                ...
                for pw in passlist:
                        ...
                        ua = random.choice(['Mozilla/5.0 (iPhone, CPU iPhone 4_4_8 like Mac OS 13) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/14Z92) Safari/604.1','Mozilla/5.0 (iPhone, CPU iPhone 13_7_4 like Mac OS 13) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15P99) Safari/604.1','Mozilla/5.0 (iPhone, CPU iPhone 5_8_5 like Mac OS 11) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/10Y117) Safari/604.1','Mozilla/5.0 (iPhone, CPU iPhone 11_4_7 like Mac OS 10) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/18Z89) Safari/604.1'])
